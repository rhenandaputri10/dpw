...
<body>
    ...
    <div class="card form-card fade-in">
        ...
        <form action="proses_editdosen.php" method="post">
            ...
            <div class="form-group">
                <label for="noHPdosen">No HP</label>
                <input type="tel" name="noHPdosen" id="noHPdosen" value="<?php echo $data['noHPdosen']; ?>" required>
            </div>
            <div class="form-actions">
                <button type="submit" name="edit" class="btn btn-success">Update Data</button>
                <a href="view_dosen.php" class="btn btn-danger">← Batal</a>
            </div>
        </form>
    </div>
