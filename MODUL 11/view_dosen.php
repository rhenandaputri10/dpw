...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="view_dosen.php" class="active">Dosen</a></li>
    ...
    <div class="card fade-in">
        ...
        <div class="actions-bar">
            <form class="search-bar" method="GET" action="view_dosen.php">
                ...
                <?php
                  ...
                  if (mysqli_num_rows($result) > 0) {
                      ...
                      while ($data = mysqli_fetch_assoc($result))
                      {
                          ...
                          echo "<td>$data[noHPdosen]</td>"; //menampilkan data noHP
                          // membuat link untuk mengedit dan menghapus data
                          echo '<td class="action-links">
                              <a href="edit_dosen.php?idDosen='.$data['idDosen'].'" class="btn btn-warning btn-sm">Edit</a>
                              <a href="hapus_dosen.php?idDosen='.$data['idDosen'].'" class="btn btn-danger btn-sm"
